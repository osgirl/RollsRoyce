            ...
            v = function(t) {
                ...
                return o.__extends(e, t), e.prototype.handleIncomingActivity = function(t) {
                    ...
                    t.format.options.showHeader && (e = i.createElement("div", {
                        className: "wc-header"
                    }, i.createElement("img",{className: "botIcon",src:'./royce-icon.png',alt:'bot icon',width:'50px',height:'60px'}),
                    i.createElement("span", {className: "botHeading"},null, t.format.strings.title),
                    i.createElement("span", {id: "close-btn",className: "close-btn-span fa fa-angle-down"})
                    // i.createElement("img",{id:"close-btn",src:'./close.png',alt:'close icon',width:'25px',height:'25px'}),
                    // i.createElement("span", {id:"minimize-btn",className: "minimize-btn-span fa fa-window-minimize"}),
                    // i.createElement("span",{id:"maximize-btn",className: "maximize-btn-span fa fa-window-maximize"})
                    ));
                    var n;
...
{                       
                     ...
                     o.createElement("div", {
                        className: "wc-message wc-message-from-me",
                        ref: function(t) {
                     ...
                     o.createElement("div", {
                        ...
                        className: "wc-message-from wc-message-from-me"
                    }, t))
}
else
{
        return o.createElement("div", {
                     ...
                     o.createElement("div", {
                        className: "wc-message wc-message-from-bot",
                        ref: function(t) {
                            return e.messageDiv = t
                        }
                    },                  
                    ...
                    // }
                     o.createElement("div", {
                        ...
                        className: "wc-message-from wc-message-from-bot"
                    }, t))
}
